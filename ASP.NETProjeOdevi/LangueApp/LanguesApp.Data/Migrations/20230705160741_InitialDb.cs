    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Merhabalar Ben Ecem Ünal Bogaz İçi Üniversitesi İngilizce Bölümü mezunuyum 1 yıldır İngilizce Ögretmeniyim.", 28, "Turkey", "Admin", new DateTime(2023, 7, 5, 19, 7, 41, 473, DateTimeKind.Local).AddTicks(6372), null, null, "Ecem Ünal", "ilk Ogermen ImageUrl", false, null, null, 220m, "ilk Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 2, "Hi I am Hannibal Lecter. I am 33 years old.I have Experience 5 years be Germany teacher.And I am teaching russian langue", 28, "North America", "Admin", new DateTime(2023, 7, 5, 19, 7, 41, 473, DateTimeKind.Local).AddTicks(6377), null, null, "Hannibal Lecter ", "ikinci Ogretmen ImageUrl", false, null, null, 300m, "ikinci Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 3, "Hi I am Ragnar Lotbrook. I am 38 years old.I have Experience 10 years be Russian teacher and I have experiance english ", 38, "Kremlin", "Admin", new DateTime(2023, 7, 5, 19, 7, 41, 473, DateTimeKind.Local).AddTicks(6380), null, null, "Ragnar Lotbrook", "Ucuncu Ogretmen ImageUrl", false, null, null, 350m, "Ucuncu Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 4, "Merhaba Ben Yagmur su 35 yaşındayim 8 yıldır Sümer Dili Ve edebiyati Ögretmenligi yapiyorum ayni zamanda Fransizca ögretmenligi yapiyorum.", 35, "Turkey", "Admin", new DateTime(2023, 7, 5, 19, 7, 41, 473, DateTimeKind.Local).AddTicks(6383), null, null, "Yagmur Su", "Dorduncu Ogretmen ImageUrl", false, null, null, 280m, "Dorduncu Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 5, "Merhaba Ben Ümit Ozdag 8 yıldır Arap Dili Ve Edebiyati Ögretmenligi Yapiyorum Suan Zafer Dersanesinde Arapça Ogretmeniyim.Ve Türk Dili ve Edebiyati Dersi veriyorum.", 42, "Suriye", "Admin", new DateTime(2023, 7, 5, 19, 7, 41, 473, DateTimeKind.Local).AddTicks(6386), null, null, "Umit Ozdag", "Besinci Ogretmen ImageUrl", false, null, null, 320m, "Besinci Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 6, "Merhaba Bendeniz Atilla Kurt Yasım 34 ve 6 yıldır Türk Dili Ve Edebiyatı Ögretmeniyim. 3 yıllık İtalyanca Tecrübem var ", 34, "Turkiye", "Admin", new DateTime(2023, 7, 5, 19, 7, 41, 473, DateTimeKind.Local).AddTicks(6389), null, null, "Atilla Kurt", "Altıncı Ogretmen ImageUrl", false, null, null, 200m, "Altıncı Ogretmen" });
