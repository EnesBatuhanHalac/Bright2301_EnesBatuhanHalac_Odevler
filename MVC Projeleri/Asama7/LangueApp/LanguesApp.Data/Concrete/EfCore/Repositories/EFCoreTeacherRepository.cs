    ...
    public class EFCoreTeacherRepository : EFCoreGenericRepository<Teacher>, ITeacherRepository
    {
      ...
      LanguesAppDbContext _context= new LanguesAppDbContext();
        ...
        public async Task<List<Teacher>> GetAllActiveTeachersAsync(string langueurl = null, string teacherurl = null)
        {
            ...
            {
                result = result
                .Where(b => b.LangueTeachers.Any(bc => bc.Langue.Url == langueurl))
                .AsQueryable();
            }
        ...
        {
            var result = _context.Teachers.Where(c => c.IsDeleted == IsDeleted).AsQueryable();
            return await result.ToListAsync();
        }
        ...
        {
            var result = _context.Teachers.Where(t => t.Url == url).FirstOrDefault();
            return result;
        }
