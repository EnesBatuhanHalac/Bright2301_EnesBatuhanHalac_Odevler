...
namespace LanguesApp.Business.Concrete
{
    public class LangueManager:ILangueService
    {
        ...
        public async Task<List<Langue>> GetLangueDeletedOrNot(bool IsDeleted, bool? IsActive = null)
        {
            var result = await _repository.GetLangueDeletedOrNot(IsDeleted, IsActive);
            return result;
        }
