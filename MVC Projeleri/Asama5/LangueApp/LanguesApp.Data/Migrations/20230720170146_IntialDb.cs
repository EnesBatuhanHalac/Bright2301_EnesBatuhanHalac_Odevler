    ...
    public partial class IntialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Merhabalar Ben Ecem Ünal Bogaz İçi Üniversitesi İngilizce Bölümü mezunuyum 1 yıldır İngilizce Ögretmeniyim.", 28, "Turkey", "Admin", new DateTime(2023, 7, 20, 20, 1, 45, 949, DateTimeKind.Local).AddTicks(6398), null, null, "Ecemunal@gmail.com", "Ecem Ünal", "kadin1.jpg", true, false, null, null, "+905426742261", 220m, "ilk Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Email", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Phone", "Price", "Url" },
                values: new object[] { 2, "Hi I am Hannibal Lecter. I am 33 years old.I have Experience 5 years be Germany teacher.And I am teaching russian langue", 28, "North America", "Admin", new DateTime(2023, 7, 20, 20, 1, 45, 949, DateTimeKind.Local).AddTicks(6406), null, null, "HannibalLecter@gmail.com", "Hannibal Lecter ", "Erkek1.jpg", true, false, null, null, "+756425271963", 300m, "ikinci Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Email", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Phone", "Price", "Url" },
                values: new object[] { 3, "Hi I am Ragnar Lotbrook. I am 38 years old.I have Experience 10 years be Russian teacher and I have experiance english ", 38, "Kremlin", "Admin", new DateTime(2023, 7, 20, 20, 1, 45, 949, DateTimeKind.Local).AddTicks(6409), null, null, "RagnarLotbrook@gmail.com", "Ragnar Lotbrook", "Erkek2.jpg", true, false, null, null, "+709624789231", 350m, "Ucuncu Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Email", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Phone", "Price", "Url" },
                values: new object[] { 4, "Merhaba Ben Yagmur su 35 yaşındayim 8 yıldır Sümer Dili Ve edebiyati Ögretmenligi yapiyorum ayni zamanda Fransizca ögretmenligi yapiyorum.", 35, "Turkey", "Admin", new DateTime(2023, 7, 20, 20, 1, 45, 949, DateTimeKind.Local).AddTicks(6411), null, null, "SuYagmur@gmail.com", "Yagmur Su", "kadin2.jpg", true, false, null, null, "+905346712263", 280m, "Dorduncu Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Email", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Phone", "Price", "Url" },
                values: new object[] { 5, "Merhaba Ben Ümit Ozdag 8 yıldır Arap Dili Ve Edebiyati Ögretmenligi Yapiyorum Suan Zafer Dersanesinde Arapça Ogretmeniyim.Ve Türk Dili ve Edebiyati Dersi veriyorum.", 42, "Suriye", "Admin", new DateTime(2023, 7, 20, 20, 1, 45, 949, DateTimeKind.Local).AddTicks(6414), null, null, "OzdagUmit3425@gmail.com", "Umit Ozdag", "Erkek3.jpg", true, false, null, null, "+905425346734", 320m, "Besinci Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Email", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Phone", "Price", "Url" },
                values: new object[] { 6, "Merhaba Bendeniz Atilla Kurt Yasım 34 ve 6 yıldır Türk Dili Ve Edebiyatı Ögretmeniyim. 3 yıllık İtalyanca Tecrübem var ", 34, "Turkiye", "Admin", new DateTime(2023, 7, 20, 20, 1, 45, 949, DateTimeKind.Local).AddTicks(6416), null, null, "KurAtilla@gmail.com", "Atilla Kurt", "Erkek4.jpg", true, false, null, null, "+902221369523", 200m, "Altıncı Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Email", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Phone", "Price", "Url" },
                values: new object[] { 7, "Deneme ", 42, "Turkiye", "Admin", new DateTime(2023, 7, 20, 20, 1, 45, 949, DateTimeKind.Local).AddTicks(6418), null, null, "Deneme3425@gmail.com", "DenemeTeacher ingilizce", "Erkek5.jpg", false, false, null, null, "+904563219874", 2080m, "deneme Ogretmen" });
