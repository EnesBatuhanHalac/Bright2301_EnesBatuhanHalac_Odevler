    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "ilk olarak 5. yüzyılda İngiltere'de ortaya çıkmış, modern zamanlarda ise küresel bir lingua franca haline gelmiş Batı Cermen dili. İngilizce günümüzde Birleşik Krallık, Amerika Birleşik Devletleri, Karayipler, Avustralya, İrlanda, Kanada ve Yeni Zelanda'da yaşayan kişilerin çoğunluğunun anadilini oluşturmaktadır. İkinci dil ve resmî dil olarak dünya genelinde, özellikle İngiliz Milletler Topluluğu üyeleri ve çok sayıda uluslararası örgüt tarafından kullanılmaktadır.", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3320), null, null, false, null, null, "İngilizce", null });

            migrationBuilder.InsertData(
                table: "Langues",
                columns: new[] { "Id", "About", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[] { 2, "Almanca (Deutsch; Almanca telaffuz: [dɔʏtʃ]), Hint-Avrupa dillerinin Cermen dilleri koluna bağlıdır ve dünyanın yaygın lisanlarından biridir. Avrupa Birliği'nin resmî dillerinden biri ve en çok konuşulanıdır. Özellikle Almanya, Avusturya, Lihtenştayn, Lüksemburg, İsviçre'nin büyük bölümü, İtalya'nın Güney Tirol bölümü, Belçika'nın doğu kantonları, Polonya ve Romanya'nın kimi bölgeleri ve Fransa'nın Alsas-Loren bölgesinde konuşulmaktadır. Almanca içinde Fransız kelime kökenli sözcükler taşır. Almanca, eski dönemlerde Türkçede Slav dilleri ile benzer şekilde Nemçece olarak adlandırılmıştır.", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3332), null, null, false, null, null, "Almanca", null });

            migrationBuilder.InsertData(
                table: "Langues",
                columns: new[] { "Id", "About", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[] { 3, "Rusça, Beyaz Rusça ve Ukraynaca ile birlikte Hint-Avrupa dil ailesinin Slav Dilleri grubunun Doğu Slav Dilleri alt grubuna girer. 20. yüzyılda politik açıdan önemli bir dil olan Rusça, Birleşmiş Milletlerin resmi dillerinden biridir. Rusça dünya üzerinde en çok konuşulan 7. dildir.Rusça Kiril alfabesini kullanır. Çünkü Latin harfleri Rus dilindeki tüm sesleri ifade etmek için yeterli değildir.[13] Rusçada vurgu çok önemlidir. Rusça sözcüklerde vurgunun belli bir yeri yoktur.[14] DolayısıyӀa sözcükleri öğrenirken vurguyu ve telaffuzu doğru öğrenmek önemlidir. Rusça kelime okunuş vurgu bulunduğu yere bağlı olarak değişebilmektedir", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3334), null, null, false, null, null, "Rusca", null });

            migrationBuilder.InsertData(
                table: "Langues",
                columns: new[] { "Id", "About", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[] { 4, " Sümerlerin anadili. Güney Mezopotamya'da MÖ 4000 yılında konuşuluyordu. MÖ 2000'li yılların başlarında yerini konuşma dili olarak Akadcaya bıraktı, ancak Mezopotamya'da MS 1. yüzyıla kadar kutsal, şölensel, edebî ve bilimsel bir dil olarak kullanılmaya devam etti. Daha sonra ise bu dil 19. yüzyıla kadar unutuldu. Mezopotamya'da konuşulan diğer dillerin aksine Sümercenin izole dillerden olduğu kabul edilir.", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3335), null, null, false, null, null, "Sumerce", null });

            migrationBuilder.InsertData(
                table: "Langues",
                columns: new[] { "Id", "About", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[] { 5, "Türkçe, diğer pek çok Türk dili ile de paylaştığı sondan eklemeli olması ve ünlü uyumu gibi dil bilgisi özellikleri ile karakterize edilir. Dil, tümce yapısı açısından genellikle özne-nesne-yüklem sırasına sahiptir. Almanca, Arapça gibi dillerin aksine gramatik cinsiyetin (erillik, dişilik, cinsiyet ayrımı) bulunmadığı Türkçede sözcüklerin bir kısmı Arapça, Farsça ve Fransızca gibi yabancı dillerden geçmedir. Ayrıca Azerice, Gagavuzca ve Türkmence gibi diğer Oğuz dilleri ile Türkçe yüksek oranda karşılıklı anlaşılabilirlik gösterir.", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3337), null, null, false, null, null, "Turkce", null });

            migrationBuilder.InsertData(
                table: "Langues",
                columns: new[] { "Id", "About", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[] { 6, "Dünya'da yaklaşık olarak 200 milyon insan Fransızca bilmektedir. 128 milyon insan Fransızcayı anadili veya ikinci dili olarak konuşurken, 54 ülkede 72 milyon insan tarafından da bilinmekte ve konuşulmaktadır. Avrupa'da Fransa ve Monako dışında Belçika, İsviçre ve Lüksemburg ülkelerinin belirli bölgelerinde olmak üzere, Afrika ve Amerika kıtası dahil, dünyanın farklı köşelerinde resmî dil konumundadır.", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3338), null, null, false, null, null, "Fransizca", null });

            migrationBuilder.InsertData(
                table: "Langues",
                columns: new[] { "Id", "About", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[] { 7, "Arapça kendi içerisinde çeşitli değişkelere ayrılır. Bu değişkeler birbirleriyle farklı oranlarda karşılıklı anlaşılabilirllik gösterebilirler veya hiç göstermezler. Bu nedenden ötürü bazı kaynaklar bunları ayrı birer dil olarak ele almaktadır. Arapçanın standartlaştırılmış formu olan ve Kuran Arapçasını temel alan Fasih Arapça, Arap dünyasında yazı dili olarak kullanılan Arapça lehçesidir. İslam'ın kutsal kitabı Kur'an Kuran Arapçası ile yazılmıştır ve bu Müslümanların ibadet dilidir.", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3339), null, null, false, null, null, "Arapça", null });

            migrationBuilder.InsertData(
                table: "Langues",
                columns: new[] { "Id", "About", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[] { 8, "Orta Çağ itibarıyla Halk Latincesi (Vulgar Latince) çeşitli dillere ayrılmıştır. Orta Çağ'ın sonunda Floransa şehrinin kültür ve edebiyat üstünlüğü etkisiyle, Toskana yazı dilinden bugünkü İtalyanca şekillenmiştir. Dilin gelişiminde Boccaccio, Dante Alighieri ve Petrarca gibi isimlerin Latince yerine Toskana ağzını kullanmalarının büyük etkisi vardır. Buna rağmen İtalyan dili, siyasi birliğin de uzun zaman tamamlanamamış olmasının da etkisiyle bölgeden bölgeye büyük farklılıklar taşır. Her bölgenin kendine özgü şivesi vardır. Buna ek olarak İtalyanca gibi Halk Latincesinden türemiş ancak İtalyancadan farklı ve karşılıklı anlaşılabilirlik göstermeyen 30 civarı dil de İtalyada bulunmaktadır. Çoğu İtalyanca konuşuru hem İtalyanca ve şivelerini, hem de kendi bölgesel dillerini (örneğin Sicilyaca veya Furlanca) konuşmaktadır.", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(3341), null, null, false, null, null, "Italyanca", null });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 1, "Merhabalar Ben Ecem Ünal Bogaz İçi Üniversitesi İngilizce Bölümü mezunuyum 1 yıldır İngilizce Ögretmeniyim.", 28, "Turkey", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(5416), null, null, "Ecem Ünal", "kadin1.jpg", true, false, null, null, 220m, "ilk Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 2, "Hi I am Hannibal Lecter. I am 33 years old.I have Experience 5 years be Germany teacher.And I am teaching russian langue", 28, "North America", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(5422), null, null, "Hannibal Lecter ", "Erkek1.jpg", true, false, null, null, 300m, "ikinci Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 3, "Hi I am Ragnar Lotbrook. I am 38 years old.I have Experience 10 years be Russian teacher and I have experiance english ", 38, "Kremlin", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(5424), null, null, "Ragnar Lotbrook", "Erkek2.jpg", true, false, null, null, 350m, "Ucuncu Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 4, "Merhaba Ben Yagmur su 35 yaşındayim 8 yıldır Sümer Dili Ve edebiyati Ögretmenligi yapiyorum ayni zamanda Fransizca ögretmenligi yapiyorum.", 35, "Turkey", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(5427), null, null, "Yagmur Su", "kadin2.jpg", true, false, null, null, 280m, "Dorduncu Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 5, "Merhaba Ben Ümit Ozdag 8 yıldır Arap Dili Ve Edebiyati Ögretmenligi Yapiyorum Suan Zafer Dersanesinde Arapça Ogretmeniyim.Ve Türk Dili ve Edebiyati Dersi veriyorum.", 42, "Suriye", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(5429), null, null, "Umit Ozdag", "Erkek3.jpg", true, false, null, null, 320m, "Besinci Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 6, "Merhaba Bendeniz Atilla Kurt Yasım 34 ve 6 yıldır Türk Dili Ve Edebiyatı Ögretmeniyim. 3 yıllık İtalyanca Tecrübem var ", 34, "Turkiye", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(5431), null, null, "Atilla Kurt", "Erkek4.jpg", true, false, null, null, 200m, "Altıncı Ogretmen" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "About", "Age", "Country", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "FullName", "ImageUrl", "IsActive", "IsDeleted", "ModifiedBy", "ModifiedDate", "Price", "Url" },
                values: new object[] { 7, "Deneme ", 42, "Turkiye", "Admin", new DateTime(2023, 7, 11, 4, 36, 18, 84, DateTimeKind.Local).AddTicks(5432), null, null, "DenemeTeacher ingilizce", "Erkek5.jpg", false, false, null, null, 2080m, "deneme Ogretmen" });
