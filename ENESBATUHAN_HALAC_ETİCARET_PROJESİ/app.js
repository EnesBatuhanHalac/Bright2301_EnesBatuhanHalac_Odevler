...
const listBasketItems = () => {
  ...
  basketListEl.innerHTML = basketListHtml
    ? basketListHtml
    : `<li class="basket__item">Sepetinde Ürün Yok!! Hadi Git Ve bir Kitap Satın Al...</li>`;
  ...
  if (findedBook) {
    ...
    if (basketAlreadyIndex == -1) {
      ...
      if (
        ...
        toastr.error("Üzgünüm Bu Ürün'den Stoklarimizda Bulunamadi.");
        return;
      }
    }
    listBasketItems();
    toastr.success("Sepete Ekleme basari ile Gerçekleşti..");
  }
};
...
const increaseItemToBasket = (bookId) => {
  ...
  if (findedIndex != -1) {
    if (
      ...
      basketList[findedIndex].quantity += 1;
    else toastr.error("Üzgünüm Bu Ürün'den Stoklarimizda Bulunamadi.");
    listBasketItems();
  }
};
